...
def train_actor(b_s,b_means,b_prob,b_gae,b_a,SIGma):
    with tf.GradientTape() as tape: 
        ...
        Entr = 0.5 + tf.reduce_mean(tf.math.log(Sigma),-1) # Entropy  
        Q = 0.01*Entr - dq2   # pi * (Entropy -Q) * rate + klra * kl_normal(xt,b_means,Sigma,SIGma)
...
if __name__ == "__main__":
    ...
    lr_schedual = optimizers.schedules.ExponentialDecay(2e-4,2000,0.999,staircase=True)
