...
if __name__ == "__main__":
    ...
    lr_schedual = optimizers.schedules.ExponentialDecay(1.5e-4,10000,0.98,staircase=True)
    optimizer_ac = optimizers.Adam(learning_rate = lr_schedual,epsilon=1e-8) # mixed_precision.LossScaleOptimizer()
    lr_schedual = optimizers.schedules.ExponentialDecay(2e-4,10000,0.98,staircase=True)
